...
- SQLite-backed provider/model config and recent request logs
...
The compose setup mounts `./data` into `/app/data` so SQLite config and logs persist across container restarts.
